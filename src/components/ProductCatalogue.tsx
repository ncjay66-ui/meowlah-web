...
function Catalogue() {
  ...
  return <div className="shop-shell">
    ...
    <p className="shop-note shop-catalog-note">{w('Older listings still need seller and pack checks. Prices are references excluding delivery. Products without an image or a working affiliate offer are held out of the catalogue.', '旧商品的商家与规格仍待复核；价格为不含运费的参考价。缺少图片或有效联盟购买入口的商品暂不展示。', 'Penyenaraian lama masih memerlukan semakan penjual dan pek. Harga rujukan tidak termasuk penghantaran. Produk tanpa imej atau tawaran afiliasi yang berfungsi tidak dipaparkan.')}</p>
